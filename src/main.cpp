...
uint256 hashGenesisBlock("0x6b91288b840c05664626cf6feeadda90cd9dab5e3b5866128831ef4e634ffa51");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xed64d4395da9ee5ddd0bb6b82f72010c777a2e616c832971fa802a55fdc75e33");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1396410497;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 146540;

        if (fTestNet)
        {
            block.nTime    = 1396409479;
            block.nNonce   = 577077;
        }
